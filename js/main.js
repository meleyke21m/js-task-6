...
//         if(itme.eyeColor =="Green")
//         Colorgreen.push(itme)
//     }
...
//     let Francisco=[];
//     for(let itme of users){
//         if(itme.address.city === "San Francisco") {
//             Francisco.push(itme)
//         }   
...
//     let getdata=[];
//     for(let itme of users){
//         if(itme.department === " Engineering") {
//             getdata.push(itme)
//         }
//     }
// console.log(getdata);
...
//     let male1=[];
//     let female1=[];
//     let female=users.filter((itme)=>itme.gender=="female")
//     let male=users.filter((itme)=>itme.gender=="male")
...
// function deleteArrayElementByName(array, name) {
...
//   deleteArrayElementByName(users, "Addison");
//   console.log("Arraydən Addison silindikdən sonra:", users);
